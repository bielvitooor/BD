...
CREATE TABLE Setor_has_Registros(
  ...
  CONSTRAINT fk_Setor_has_Registros_Registros1
   ...
   INSERT INTO adrianob_grupo09.Sexo(id_sexo,descricao_sexo) values(2,"Feminino");
    ...
    INSERT INTO adrianob_grupo09.Pessoas(nome,matricula,cpf,email,telefone,dt_nasc,sexo_id_sexo) values("Vanessa",20203930249373, 11104046781,"vanessa@gmail.com","(62)98607-3404","2004-03-19", 2);
    INSERT INTO adrianob_grupo09.Pessoas(nome,matricula,cpf,email,telefone,dt_nasc,sexo_id_sexo) values("Bruna",20203930455403, 45512335565,"bruna@gmail.com","(62)99856-9858","2003-01-28",2);
    INSERT INTO adrianob_grupo09.Pessoas(nome,matricula,cpf,email,telefone,dt_nasc,sexo_id_sexo) values("Isaque",20203930455403, 11254785458,"isaque@gmail.com","(62)99856-9858","2004-03-17",1);
