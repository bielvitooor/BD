...
CREATE TABLE Pessoa (
  ...
  Cargo_Setor_id_setor INT  NOT NULL,
...
CONSTRAINT fk_Usuario_Pessoa
    FOREIGN KEY (Pessoa_id_pessoas)
    REFERENCES Pessoa(id_pessoa)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
CONSTRAINT fk_Usuario_Pessoa1
	FOREIGN KEY(Pessoa_sexo_id_sexo)
    REFERENCES Pessoa(sexo_id_sexo)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
CONSTRAINT fk_Usuario_Cargo
    FOREIGN KEY (Cargo_Setor_id_setor)
    REFERENCES Cargo (Setor_id_setor)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
CREATE TABLE Registro (
 num_registro INT UNIQUE NOT NULL AUTO_INCREMENT,
  ...
  Usuario_Cargo_Setor_id_setor INT NOT NULL,
...
CONSTRAINT fk_Registro_Usuario1
    FOREIGN KEY (Usuario_curso_id_curso)
    REFERENCES Usuario (curso_id_curso)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
CONSTRAINT fk_Registro_Usuario2
    FOREIGN KEY (Usuario_Pessoa_id_pessoas)
    REFERENCES Usuario (Pessoa_id_pessoas)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
CONSTRAINT fk_Registro_Usuario3
    FOREIGN KEY (Usuario_Pessoa_sexo_id_sexo)
    REFERENCES Usuario (Pessoa_sexo_id_sexo)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
CONSTRAINT fk_Registro_Usuario4
    FOREIGN KEY (Usuario_Cargo_id_cargo)
    REFERENCES Usuario(Cargo_id_cargo)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
CONSTRAINT fk_Registro_Usuario5
    FOREIGN KEY (Usuario_Cargo_Setor_id_setor)
    REFERENCES Usuario(Cargo_Setor_id_setor)
    ON DELETE CASCADE
    ON UPDATE CASCADE
  );
